...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.amostraname = QtWidgets.QLabel(Form)
        self.amostraname.setGeometry(QtCore.QRect(280, 270, 251, 16))
        self.amostraname.setObjectName("amostraName")

        self.retranslateUi(Form)
        QtCore.QMetaObject.connectSlotsByName(Form)

        self.inserirButton.clicked.connect(self.inserir)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Inserir Amostra"))
        ...
        self.amostraname.setText(_translate("Form", "Nome da Amostra:"))
    ...
    def inserir(self):
        ...
        if _name and _mp10 and _mp25 and _o3 and _co and _no2 and _so2:
            resp = sql.inserir(self.ar, _name, int(_mp10), int(_mp25), int(_o3), int(_co), int(_no2), int(_so2))
            msg.setText(resp)
        else:
